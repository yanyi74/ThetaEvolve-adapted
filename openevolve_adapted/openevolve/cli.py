...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", "-o", 
                       help="Output directory for results (default: 'openevolve_output' in initial program directory)", 
                       default=None)
    ...
    parser.add_argument("--random-seed", type=int, help="Random seed for reproducibility (overrides config value)", default=None)
...
async def main_async() -> int:
    ...
    Returns:
        Exit code
    """
    # Auto-configure PYTHONPATH for OpenEvolve if not set
    openevolve_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    ...
    if 'PYTHONPATH' not in os.environ:
        os.environ['PYTHONPATH'] = openevolve_root
    elif openevolve_root not in os.environ['PYTHONPATH']:
        os.environ['PYTHONPATH'] = f"{openevolve_root}:{os.environ['PYTHONPATH']}"
    ...
    config = None
    if args.api_base or args.primary_model or args.secondary_model or args.random_seed is not None:
        ...
        if args.random_seed is not None:
            ...
            print(f"[OE] Using random seed: {config.random_seed}")
