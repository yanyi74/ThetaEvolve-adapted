    ...
    try:
        ...
        def enhance_programs_with_artifacts(programs, include_artifacts):
            ...
            for p in programs:
                ...
                artifacts = db_snapshot["artifacts"].get(p.id)
                if artifacts:
        ...
        include_top_artifacts = _worker_config.prompt.include_artifacts_for_all_programs or _worker_config.prompt.include_top_program_artifacts
        include_inspiration_artifacts = _worker_config.prompt.include_artifacts_for_all_programs or _worker_config.prompt.include_inspiration_artifacts
